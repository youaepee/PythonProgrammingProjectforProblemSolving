...
def percent(num):
    if stream.lower()=='cse' or stream.lower()=='cseai' or stream.lower()=='cseaiml' or stream.lower()=='cseiotcsbs' or stream.lower()=='it' :
        num=(num*100)//600
    elif stream.lower()=='ece' or stream.lower()=='me':
        num=(num*100)//500
    return num
...
def get_batch():
    with open('C:/PythonProject_main/Batch.csv','r') as f:
        reader=csv.reader(f)
...
def remove(string):
    with open('C:/PythonProject_main/Student.csv','r+',newline='') as f:
        script=csv.reader(f)
